...
# Import data
filename1 = 'Data/TrainData.csv'
filename2 = 'Data/Solution.csv'
filename3 = 'Data/WeatherForecastInput.csv'
...
def support_vector_regression(X_train, y_train, X_test, y_test,params=None, plot=True, gridsearch=False):
    '''
